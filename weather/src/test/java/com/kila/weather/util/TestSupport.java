...
public class TestSupport {
    ...
    public Instant getCurrentInstant() {
        String instantExpected = "2023-08-06T10:15:30Z";
    ...
    public Weather getSavedWeatherEntity(String responseLocalTime) {
    ...
    public Weather getToSavedWeatherEntity(String responseLocalTime) {
        return new Weather(requestedCity,
                "Amsterdam",
                "Netherlands",
                20,
                getCurrentLocalDateTime(),
